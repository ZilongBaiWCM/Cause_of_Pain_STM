...
ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/Fig2D_Kendall_test_p_value_vs_top_k_summary_score_LS_sorted_HSS",".png",sep=""), width = 6, height = 6, dpi = 300, units = "in", device='png')
...
ggsave(file=paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/Fig2C_Laplacian_Score_kth_single_gene_LS_sorted_HSS",".png",sep=""), width = 6, height = 6, dpi = 300, units = "in", device='png')
