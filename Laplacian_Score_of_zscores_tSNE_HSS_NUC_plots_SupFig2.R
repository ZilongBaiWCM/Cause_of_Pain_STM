...
ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/Kendall_test_p_value_vs_top_k_summary_score_LS_sorted_NUC",".png",sep=""), width = 8, height = 6, dpi = 300, units = "in", device='png')
...
ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/Laplacian_Score_kth_single_gene_LS_sorted_NUC",".png",sep=""), width = 8, height = 6, dpi = 300, units = "in", device='png')
