...
ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/summary_scores_vs_average_cell_density_SupFig2",".png",sep=""), width = 8, height = 5, dpi = 300, units = "in", device='png')
#dev.off()
######
...
sp_ls.tsne + 
  ...
  scale_y_continuous(limits=c(1500, 7000)) #name="Cell Density", 
ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/summary_scores_vs_average_cell_density_5000_genes_SupFig2",".png",sep=""), width = 8, height = 5, dpi = 300, units = "in", device='png')
#dev.off()
