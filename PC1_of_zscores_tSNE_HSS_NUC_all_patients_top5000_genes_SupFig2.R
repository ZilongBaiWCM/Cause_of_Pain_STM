...
ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/pc1_vs_average_cell_density_all_patients_5000_genes_SupFig2",".png",sep=""), width = 8, height = 5, dpi = 300, units = "in", device='png')
